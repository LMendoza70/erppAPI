...
@Entity
@Table(name = "auxiliar_persona")
public class AuxiliarPersona implements Serializable {

    private static final long serialVersionUID = 1L;

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "auxiliarPersonaGenerator")
    @SequenceGenerator(allocationSize = 1, name = "auxiliarPersonaGenerator", sequenceName="auxiliar_persona_seq")
    private Long id;
