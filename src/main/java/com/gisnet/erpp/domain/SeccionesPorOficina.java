...
public class SeccionesPorOficina implements Serializable {
    ...
    public SeccionesPorOficina observaciones(String observaciones){
    ...
    public SeccionesPorOficina oficina(Oficina oficina) {
    ...
    public SeccionesPorOficina seccion(Seccion seccion) {
    ...
    public boolean equals(Object o) {
        ...
        SeccionesPorOficina seccionesPorOficina = (SeccionesPorOficina) o;
